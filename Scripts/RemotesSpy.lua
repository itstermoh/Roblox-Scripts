...
----  (kinda sorta mostly) BY GUI to LUA ----
...
function genScript(remote, args)
	...
	gen = "-- Script  by SimpleSpy - credits to exx#9394\n\n" .. gen
	prevTables = {}
	if remote:IsA("RemoteEvent") or remote:IsA("RemoteFunction") then
	  wait(0.2)
	  writefile('/Remotes/spy0.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy1.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy2.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy3.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy4.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy5.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy6.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy7.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy8.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy9.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy10.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy11.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy12.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy13.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy14.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy15.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy16.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy17.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy18.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy19.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy20.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy21.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy22.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy23.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy24.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy25.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy26.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy27.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy28.txt', gen)
    wait(0.01)
    writefile('/Remotes/spy29.txt', gen)
    wait(0.01)
	end
	return gen
end
...
function t2s(t, l, p, n, vtv, i, pt, path, tables, tI)
	...
	for k, v in pairs(t) do -- iterates over table
		...
		if size > (_G.SimpleSpyMaxTableSize or 1000000) then
			s = s
				.. "\n"
				.. string.rep(" ", l)
...
--[[
    Some helpful things:
        ...
        -  scripts are  when the namecall is initially fired and saved in remoteFrame objects
        - blacklisted remotes will be ignored directly in namecall (less lag)
        - the properties of a 'remoteFrame' object:
            {
                Name: (string) The name of the Remote
                GenScript: (string) The  script that appears in the codebox ( when namecall fired)
...
newButton("Function Info", function()
	...
	if selected then
		if selected.Function then
			codebox:setRaw(
				"-- Calling function info\n--  by the SimpleSpy serializer\n\n" .. tostring(selected.Function)
			)
		end
		TextLabel.Text = "Done! Function info  by the SimpleSpy Serializer."
	end
end)
